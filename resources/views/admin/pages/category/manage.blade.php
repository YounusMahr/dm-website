        ...
        <div class="container-fluid">
            <div class="card">
                <div class="d-flex flex-row justify-content-between m-4 ">
                 ...
                 <button type="button" class="btn bg-primary  rounded  " onclick="window.location.href='{{ route("category.show") }}'" style="color:white">Clear fitler</button>
                 </div>
                ...
                <div class="card-body table-responsive p-0">
                    <table class="table table-hover text-nowrap">
                        ...
                        <tbody>
                            ...
                            @foreach ( $categorys->sortByDesc('created_at') as $index => $category)
                              <tr>
                                <td>
                                    {{ ($index % 3) + 1 }}.
                                </td>
                                ...
                                <td>
                                    ...
                                    <a  style="cursor: pointer" onclick="deleteCategory({{ $category->id }})" class="text-danger w-4 h-4 mr-1">
