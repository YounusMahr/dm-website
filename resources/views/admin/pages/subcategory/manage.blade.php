        ...
        <div class="container-fluid">
            <div class="card">
                <div class="d-flex flex-row justify-content-between m-4 ">
                 ...
                 <button type="button" class="btn bg-primary  rounded  " onclick="window.location.href='{{ route("subcategory.show") }}'" style="color:white">Clear fitler</button>
                 </div>
                ...
                <div class="card-body table-responsive p-0">
                    <table class="table table-hover text-nowrap">
                        ...
                        <tbody>
                            ...
                            @foreach ( $subcategorys->sortByDesc('created_at') as $index => $subcategory)
                              <tr>
                                <td>
                                    {{ ($index % 3) + 1 }}.
                                </td>
                                ...
                                <td>
                                    <img src="{{asset('uploads/subcategory/'.$subcategory->image) }}" alt="" height="50px" width="50px"
                                    ></td>
                                ...
                                <td>
                                    ...
                                    <a  style="cursor: pointer" onclick="deletesubcategory({{ $subcategory->id }})" class="text-danger w-4 h-4 mr-1">
